export const translationEN = {
  ...
  addAccount: {
    ...
    updateSuccess: "{{accName}} account updated successfully",
    addSuccess: "{{accName}} account has been created",
    deleteSuccess: "{{accName}} account has been removed",
  ...
  addProjects: {
    ...
    startDate: "SOW Start Date",
    pointOfContact: "Point of contact",
    teamMembers: "Team Members",
    pmo: "PMO",
    scrumTeam: "SCRUM Team",
    lead: "Lead",
    placeholderPOC: "First Name /Last Name / Email ID",
