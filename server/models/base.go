...
func init() {
	...
	db = conn
	db.Debug().AutoMigrate(&schema.Tenant{}, &schema.Account{}, &schema.Project{}, &schema.User{}, &schema.UserProject{}, &schema.UserFeedback{}, &schema.McqQuestions{}, &schema.SurveyFormat{}, &schema.Survey{})
}
