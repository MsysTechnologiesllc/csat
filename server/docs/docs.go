...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/models.UpdateAnswerRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/survey-format": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Survey format retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/user-projects": {
            "get": {
                "description": "Retrieve Project Details of users based on User ID",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Get Project Details list",
                "parameters": [
                    {
                        "type": "integer",
                        "default": 328,
        ...
        "/api/account": {
            "get": {
                "description": "Retrieve Account Details  based on Tenant ID",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Get Account Details list",
                "parameters": [
                    {
                        "type": "integer",
                        "default": 1001,
    ...
    "definitions": {
        "controllers.UpdateAnswerRequest": {
            "type": "object"
        },
        "models.LoginRequest": {
            "type": "object",
        ...
        "models.UpdateAnswerRequest": {
            "type": "object",
            "properties": {
                "survey": {
                    "$ref": "#/definitions/schema.Survey"
                }
            }
        },
